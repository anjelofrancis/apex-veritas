    ...
    <section className="py-24 px-6 relative z-10 text-white pb-40">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">No hidden fees, no surprises. Choose the plan that best fits your needs.</p>
        </div>
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`p-8 rounded-3xl border ${
                plan.highlighted 
                  ? 'bg-gradient-to-b from-gray-800 to-gray-900 border-teal shadow-2xl shadow-teal/20 transform md:-translate-y-4' 
