        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">Last 7 months of growth</p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white/5 p-6 rounded-2xl border border-divider">
              <p className="text-gray-400 text-sm mb-1">Weekly Traffic</p>
            ...
            <div className="bg-white/5 p-6 rounded-2xl border border-divider flex flex-col justify-between">
               ...
               <p className="text-sm text-gray-400">Up 1.2% from last week. Checkout flow optimizations are showing positive results.</p>
            </div>
            ...
            <div className="bg-white/5 p-6 rounded-2xl border border-divider flex flex-col justify-between">
               ...
               <p className="text-sm text-gray-400">Stable across all platforms. Mobile users represent 62% of total session time.</p>
            </div>
          </div>
        </motion.div>
      </div>
